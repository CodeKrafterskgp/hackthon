    ...
    return (
        ...
        <div className="subject">
            <div className="subbar">
                ...
                <div className="subbar2">CPT CH1 </div>
            ...
            <div className="subject1">
                ...
                <div className="subicon"><a href="https://docs.google.com/document/d/1o_vzH0E87Ho9X0lNg5RQmIGaIvOpSv-gLKIUFGgMEn4/edit?addon_store"><img src={syl} alt="SUBJECTS" /><p>Syllabus</p></a></div>
